...
class SuperViewController: UIViewController {
    ...
    private var isExpanded: Bool = false // This variable is used to check if the side menu is being displayed
    ...
    override public func viewDidLoad() {
        ...
        // If sideMenuOnTop = true we position the shadow view at index 1
        ...
        // If sideMenuOnTop = true we position the side menu at index 2, else we position the side menu at index 0
        view.insertSubview(self.sideMenuViewController!.view, at: self.revealSideMenuOnTop ? 2 : 0)
        addChild(self.sideMenuViewController!)
        self.sideMenuViewController!.didMove(toParent: self)
        
        // Side Menu AutoLayout
        // In this section we asign the initial constraints to our side menu
        self.sideMenuViewController.view.translatesAutoresizingMaskIntoConstraints = false
        
        /* If sideMenuOnTop = true we relate the leading anchor of the "main controller view" to the
         * leading anchor of the "side menu controller" and we hide the side menu by subtracting
         ...
         * We relate the value of the top anchor and the bottom anchor of our side menu
         * with the values of the top anchor and the bottom anchor of our main view controller
         */
...
extension SuperViewController: SideMenuViewControllerDelegate {
...
extension UIViewController {
    ...
    func revealViewController() -> SuperViewController? {
        ...
        if viewController != nil && viewController is SuperViewController {
            return viewController! as? SuperViewController
        }
        while (!(viewController is SuperViewController) && viewController?.parent != nil) {
            viewController = viewController?.parent
        }
        if viewController is SuperViewController {
            return viewController as? SuperViewController
        }
        return nil
    }
...
extension SuperViewController: UIGestureRecognizerDelegate {
    // This method is called when we tap in the shadowView
